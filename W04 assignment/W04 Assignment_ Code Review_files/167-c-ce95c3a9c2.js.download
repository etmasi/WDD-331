(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[167],{"0Pgl":function(e,t,n){"use strict"
var r=n("GLiE")
var o=n.n(r)
var i=n("FIFq")
var a=n("fPNa")
...
this.type=_.type
n&&""!==n&&(this.text=n)}get properties(){return Object.freeze(["url","title","text","icon","thumbnail","iframe","custom","lookup_id"])}toHtmlString(){if(this.iframe&&this.iframe.src)return this.iframeTag()
...
this.url=`${t}?${this.ltiEndpointParams(e.url,e.lookup_id)}`}ltiEndpointParams(e,t){let n="display=borderless"
null!==t&&void 0!==t&&(n+="&resource_link_lookup_id="+t)
...
//# sourceMappingURL=167-c-ce95c3a9c2.js.map