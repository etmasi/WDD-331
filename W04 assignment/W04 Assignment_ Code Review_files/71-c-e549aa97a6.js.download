(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[71],{"3UD+":function(e,n){e.exports=function(e){if(!e.webpackPolyfill){var n=Object.create(e)
...
n.webpackPolyfill=1}return n}},"5JRF":function(e,n,t){"use strict"
...
var B=(_=Object(y["a"])("7.0.0",null,"Use Text from ui-text instead."),O=Object(h["j"])(m,U),_(k=O(k=(w=x=function(e){Object(l["a"])(n,e)
...
var t=this.props,r=t.wrap,i=t.weight,a=t.fontStyle,c=t.size,l=t.lineHeight,s=t.letterSpacing,b=t.transform,d=t.color,f=t.children
var h=Object(v["a"])(n,this.props)
return u.a.createElement(h,Object.assign({},Object(g["a"])(this.props,n.propTypes),{className:p()((e={},Object(o["a"])(e,U.root,true),Object(o["a"])(e,U[c],c),Object(o["a"])(e,U["wrap-".concat(r)],r),Object(o["a"])(e,U["weight-".concat(i)],i),Object(o["a"])(e,U["style-".concat(a)],a),Object(o["a"])(e,U["transform-".concat(b)],b),Object(o["a"])(e,U["lineHeight-".concat(l)],l),Object(o["a"])(e,U["letterSpacing-".concat(s)],s),Object(o["a"])(e,U["color-".concat(d)],d),e)),ref:this.props.elementRef}),f)}}])
n.displayName="Text"
return n}(s["Component"]),x.propTypes={as:d.a.elementType,wrap:d.a.oneOf(["normal","break-word"]),weight:d.a.oneOf(["normal","light","bold"]),fontStyle:d.a.oneOf(["italic","normal"]),size:d.a.oneOf(["x-small","small","medium","large","x-large","xx-large"]),lineHeight:d.a.oneOf(["default","fit","condensed","double"]),letterSpacing:d.a.oneOf(["normal","condensed","expanded"]),transform:d.a.oneOf(["none","capitalize","uppercase","lowercase"]),color:d.a.oneOf(["primary","secondary","primary-inverse","secondary-inverse","success","error","alert","warning","brand"]),children:d.a.node,elementRef:d.a.func},x.defaultProps={as:"span",wrap:"normal",size:"medium",letterSpacing:"normal",children:null,elementRef:void 0,color:void 0,transform:void 0,lineHeight:void 0,fontStyle:void 0,weight:void 0},w))||k)||k)},"8o96":function(e,n,t){"use strict"
...
return b(e,n)})).join("")}function u(e,n){var t="plural"===n?o:i
return e.replace(/'/g,c).replace(t,"'$&'")}function b(e,n){if(e[0]===l)return l
if("number"===typeof e[2])return p(e)
return d(e)}function d(e){var n=e[0]
var t=e[1]
var o=e[2]
var r="object"===typeof o?","+h(o,t)+"\n":o?", "+f(o)+" ":" "
return"{ "+n+(t?", "+t:"")+r+"}"}function f(e){if(!r.test(e))return e.replace(/'/g,c)
return a+e.replace(/'/g,c)+a}function p(e){var n=e[0]
var t=e[1]
var o=e[2]
var r=e[3]
return"{ "+n+", "+t+","+(o?" offset:"+o:"")+h(r,t)+"\n}"}function h(e,n){var t=Object.keys(e)
var o=t.reduce((function(e,n){return Math.max(e,n.length)}),0)
return t.map((function(t){return"\n  "+y(t,o)+" {"+s(e[t],n)+"}"})).join("")}function y(e,n){var t=""
for(var o=e.length;o<n;++o)t+=" "
return t+e}},HMVb:function(e,n,t){"use strict"
...
var a=t("IPIv")
var c={}
function l(e,n){if(!r["a"])return 16
...
var r=Object(s["a"])(e),i=Object(o["a"])(r,2),a=i[0],c=i[1]
...
var B=t("oXx0")
var L=t("jtGx")
function D(e){var n=e.colors,t=e.borders,o=e.spacing,r=e.typography,i=e.forms
return{fontFamily:r.fontFamily,fontWeight:r.fontWeightNormal,color:n.textDarkest,background:n.backgroundLightest,borderWidth:t.widthSmall,borderStyle:t.style,borderTopColor:n.borderMedium,borderRightColor:n.borderMedium,borderBottomColor:n.borderMedium,borderLeftColor:n.borderMedium,borderRadius:t.radiusMedium,padding:o.small,focusOutlineColor:n.borderBrand,focusOutlineWidth:t.widthMedium,focusOutlineStyle:t.style,errorBorderColor:n.borderDanger,errorOutlineColor:n.borderDanger,placeholderColor:n.textDark,smallFontSize:r.fontSizeSmall,smallHeight:i.inputHeightSmall,mediumFontSize:r.fontSizeMedium,mediumHeight:i.inputHeightMedium,largeFontSize:r.fontSizeLarge,largeHeight:i.inputHeightLarge}}D.canvas=function(e){return{color:e["ic-brand-font-color-dark"],focusOutlineColor:e["ic-brand-primary"]}}
var G,C,S,T,z
...
var I=(G=Object(B["a"])(),C=Object(U["j"])(D,P),G(S=C(S=(z=T=function(e){Object(s["a"])(n,e)
function n(){var e
Object(r["a"])(this,n)
e=Object(a["a"])(this,Object(c["a"])(n).call(this))
...
o=e._textarea.scrollHeight+t+"px"
...
o=e.props.height}var i=Object(w["a"])(o)>r
i||(e._container.style.minHeight=o)
e._height=o
e._textarea.style.height=o
e._textarea.scrollTop=e._textarea.scrollHeight}
e.handleChange=function(n){var t=e.props,o=t.onChange,r=t.value,i=t.disabled,a=t.readOnly
...
var r=this.props,i=r.autoGrow,a=r.placeholder,c=r.value,l=r.defaultValue,s=r.disabled,u=r.readOnly,d=r.required,f=r.width,p=r.height,y=r.maxHeight,g=r.textareaRef,j=r.resize,m=r.size
var _=Object(L["a"])(this.props,n.propTypes)
var O=(e={},Object(o["a"])(e,P.textarea,true),Object(o["a"])(e,P[m],true),Object(o["a"])(e,P.disabled,s),e)
var k={width:f,resize:j,height:i?null:p,maxHeight:y}
var x=b.a.createElement("textarea",Object.assign({},_,{value:c,defaultValue:l,placeholder:a,ref:function(e){t._textarea=e
for(var n=arguments.length,o=new Array(n>1?n-1:0),r=1;r<n;r++)o[r-1]=arguments[r]
g.apply(t,[e].concat(o))},style:k,id:this.id,required:d,"aria-required":d,"aria-invalid":this.invalid?"true":null,disabled:s||u,className:h()(O),onChange:this.handleChange}))
return b.a.createElement(v["a"],Object.assign({},Object(L["c"])(this.props,v["a"].propTypes),{vAlign:"top",id:this.id,ref:function(e){t._node=e}}),b.a.createElement("div",{className:P.layout,style:{width:f,maxHeight:y},ref:this.handleContainerRef},x,s||u?null:b.a.createElement("span",{className:P.outline,"aria-hidden":"true"})))}},{key:"minHeight",get:function(){return this._textarea.style.minHeight}},{key:"invalid",get:function(){return this.props.messages&&this.props.messages.findIndex((function(e){return"error"===e.type}))>=0}},{key:"id",get:function(){return this.props.id||this._defaultId}},{key:"focused",get:function(){return Object(O["a"])(this._textarea)}},{key:"value",get:function(){return this._textarea.value}}])
...
var t=e.length
var o=r.length
for(var i=0;i<t;++i){var a=e[i]
var c=a.charCodeAt(0)-192
if(c>=0&&c<o){var l=r[c]
"."!==l&&(a=l)}n+=a}return n}function a(e){return i(e).toLowerCase().replace(/[^a-z0-9]+/g,"_").replace(/^_|_$/g,"").slice(0,50)}e.exports=function(e){return a(o(e))}
e.exports.underscore=a},RBOd:function(e,n,t){"use strict"
t.d(n,"a",(function(){return I}))
var o=t("VTBJ")
var r=t("rePB")
var i=t("1OyB")
...
var U=t("oXx0")
var B=t("o4+2")
function L(e){var n=e.colors,t=e.typography,o=e.borders,r=e.spacing
return{fontFamily:t.fontFamily,fontWeight:t.fontWeightNormal,color:n.textLink,textDecoration:"underline",textDecorationOutsideText:"none",focusOutlineWidth:o.widthMedium,focusOutlineColor:n.borderBrand,focusOutlineStyle:o.style,hoverColor:Object(B["a"])(n.textLink,10),hoverTextDecoration:"underline",colorInverse:n.textLight,focusInverseOutlineColor:n.borderLightest,focusInverseIconOutlineColor:n.borderLightest,iconSize:"1.125em",iconPlusTextMargin:r.xxSmall}}L["canvas-a11y"]=L["canvas-high-contrast"]=function(e){var n=e.colors
...
t.handleClick=function(e){var n=t.props,o=n.disabled,r=n.onClick
if(o){e.preventDefault()
e.stopPropagation()}else"function"===typeof r&&r(e)}
return t}Object(a["a"])(n,[{key:"focus",value:function(){Object(j["a"])(this._link).focus()}},{key:"renderIcon",value:function(){var e=this.props.icon
this.props.display
return"function"===typeof this.props.icon?b.a.createElement("span",{className:P.icon},b.a.createElement(e,null)):e?b.a.createElement("span",{className:P.icon},e):null}},{key:"render",value:function(){var e,t=this
var i=this.props,a=i.disabled,c=i.children,l=i.onClick,s=i.variant,u=i.href,d=i.margin,f=i.icon,p=i.iconPlacement,v=i.linkRef,g=i.elementRef,j=i.isWithinText
var m=(e={},Object(r["a"])(e,P.root,true),Object(r["a"])(e,P.inverse,"inverse"===s),Object(r["a"])(e,P["iconPlacement--".concat(p)],f&&this.hasVisibleChildren),Object(r["a"])(e,P.truncates,this.containsTruncateText),Object(r["a"])(e,P["is".concat(j?"Within":"Outside","Text")],true),e)
var _=l&&"button"!==this.element?"button":null
var O="button"===this.element||"input"===this.element?"button":null
var x="button"!==_||a?null:"0"
var w=y["a"].omitViewProps(Object(k["a"])(this.props,n.propTypes),n)
var U=Object(o["a"])({},w,{elementRef:function(e){t._link=e
"function"===typeof v&&v(e)
"function"===typeof g&&g(e)},as:this.element,display:this.display,margin:d,className:h()(m),href:u,onClick:this.handleClick,"aria-disabled":a?"true":null,role:_,type:O,tabIndex:x})
...
return this.props.icon?this.containsTruncateText?"flex":"inline-block":this.containsTruncateText?"block":"auto"}},{key:"hasVisibleChildren",get:function(){return Object(g["a"])(this.props.children)}},{key:"element",get:function(){return Object(x["a"])(n,this.props)}},{key:"focused",get:function(){return Object(m["a"])(this._link)}},{key:"focusable",get:function(){return Object(_["a"])(this._link)}},{key:"containsTruncateText",get:function(){var e=false
b.a.Children.forEach(this.props.children,(function(n){n&&Object(w["a"])(n,["TruncateText"])&&(e=true)}))
!e||this.props.display
return e}}])
n.displayName="Link"
return n}(u["Component"]),T.propTypes={href:f.a.string,children:f.a.node.isRequired,variant:f.a.oneOf(["default","inverse"]),linkRef:f.a.func,elementRef:f.a.func,as:f.a.elementType,disabled:f.a.bool,onClick:f.a.func,margin:v["c"].spacing,icon:f.a.oneOfType([f.a.func,f.a.element]),iconPlacement:f.a.oneOf(["start","end"]),display:f.a.oneOf(["auto","block","inline-block","flex","inline-flex"]),isWithinText:f.a.bool},T.defaultProps={href:void 0,elementRef:void 0,disabled:false,onClick:void 0,margin:void 0,icon:void 0,display:void 0,variant:"default",as:void 0,linkRef:function(e){},iconPlacement:"start",isWithinText:true},z))||S)||S)||S)},RhCJ:function(e,n,t){"use strict"
...
return n}},ZoNA:function(e,n,t){"use strict"
var o=t("O92E")
var r=t("CpOe")
e.exports=function(e){return r(o(e)).replace(/\s+/g," ")}},bCCX:function(e,n,t){"use strict"
t.r(n);(function(e,o){var r=t("SLVX")
var i
if("undefined"!==typeof self)i=self
else if("undefined"!==typeof window)i=window
else if("undefined"!==typeof e)i=e
else{i=o}var a=Object(r["a"])(i)
n["default"]=a}).call(this,t("yLpj"),t("3UD+")(e))},cClk:function(e,n,t){"use strict"
t.d(n,"a",(function(){return o}))
function o(e){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"onChange"
var t=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"defaultValue"
return function(o,r,i){var a=e.apply(null,arguments)
if(a)return a
if(o[r]&&"function"!==typeof o[n])return new Error(["You provided a '".concat(r,"' prop without an '").concat(n,"' handler on '").concat(i,"'. This will render a controlled component. If the component should be uncontrolled and manage its own state, use '").concat(t,"'. Otherwise, set '").concat(n,"'.")].join(""))}}},eGSd:function(e,n,t){"use strict"
t.d(n,"a",(function(){return o}))
function o(e){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0
...
var u=!!t.leading
var b="maxWait"in t
var d=!("trailing"in t)||!!t.trailing
var f=b?Math.max(+t.maxWait||0,n):0
function p(n){var t=o
var a=r
o=r=void 0
c=n
if(true!==s){i=e.apply(a,t)
return i}}function h(e){c=e
l.push(setTimeout(g,n))
return u?p(e):i}function y(e){var t=e-a
var o=e-c
var r=n-t
return b?Math.min(r,f-o):r}function v(e){var t=e-a
var o=e-c
return"undefined"===typeof a||t>=n||t<0||b&&o>=f}function g(){var e=Date.now()
if(v(e))return j(e)
l.push(setTimeout(g,y(e)))}function j(e){O()
if(d&&o)return p(e)
o=r=void 0
return i}function m(){s=true
O()
c=0
o=a=r=void 0}function _(){return 0===l.length?i:j(Date.now())}function O(){l.forEach((function(e){return clearTimeout(e)}))
...
r=this
a=e
if(t){if(0===l.length)return h(a)
if(b){l.push(setTimeout(g,n))
return p(a)}}0===l.length&&l.push(setTimeout(g,n))
return i}k.cancel=m
k.flush=_
return k}},gCYW:function(e,n,t){"use strict"
...
var n=i(e)
var t=o(e.length+":"+e).toString(16)
return n+"_"+t}},zpiH:function(e,n,t){"use strict"
