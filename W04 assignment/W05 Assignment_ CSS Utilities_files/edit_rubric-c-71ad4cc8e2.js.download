(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[355,643,660,673,677,735],{"/iD7":function(e,t,n){"use strict"
var o=n("pQTu")
var a=n("m0r6")
...
var b=n("EvX+")
var h=u.a.default
var p=h.template,_=h.templates=h.templates||{}
var f="editor/KeyboardShortcuts"
_[f]=p((function(e,t,n,o,a){this.compilerInfo=[4,">= 1.0.0"]
...
var U=(k=Object(f["a"])("7.0.0",null,"Use Text from ui-text instead."),j=Object(_["j"])(v,B),k(w=j(w=(O=x=function(e){Object(l["a"])(t,e)
...
var f=n("bZJi")
var g=n("AdN2")
var m=function(e){var t=e.typography,n=e.spacing
return{fontFamily:t.fontFamily,fontWeight:t.fontWeightNormal,fontSize:t.fontSizeSmall,padding:n.small}}
var y,v,k,j,w,x
var O={componentId:"eZLSb",template:function(e){return"\n\n.eZLSb_bGBk{box-sizing:border-box;display:block;font-family:".concat(e.fontFamily||"inherit",";font-size:").concat(e.fontSize||"inherit",";font-weight:").concat(e.fontWeight||"inherit",";padding:").concat(e.padding||"inherit","}")},root:"eZLSb_bGBk"}
var B=(y=Object(p["a"])("7.0.0",null,"Use Tooltip from ui-tooltip instead."),v=Object(_["a"])(),k=Object(h["j"])(m,O),y(j=v(j=k(j=(x=w=function(e){Object(r["a"])(n,e)
var t=Object(s["a"])(n)
function n(){Object(a["a"])(this,n)
return t.apply(this,arguments)}Object(i["a"])(n,[{key:"render",value:function(){var e=this.props,t=e.children,n=e.tip,a=e.variant,i=e.on,r=e.placement,s=e.mountNode,l=e.positionTarget,d=e.constrain,u=Object(o["a"])(e,["children","tip","variant","on","placement","mountNode","positionTarget","constrain"])
return c.a.createElement(f["a"],Object.assign({},u,{renderTip:n,on:i,color:"inverse"===a?"primary":"primary-inverse",placement:r,mountNode:s,positionTarget:l,constrain:d}),t)}}])
n.displayName="Tooltip"
return n}(l["Component"]),w.propTypes={children:u.a.oneOfType([u.a.node,u.a.func]).isRequired,tip:u.a.node.isRequired,as:u.a.elementType,on:u.a.oneOfType([u.a.oneOf(["click","hover","focus"]),u.a.arrayOf(u.a.oneOf(["click","hover","focus"]))]),variant:u.a.oneOf(["default","inverse"]),placement:b["a"].placement,mountNode:b["a"].mountNode,positionTarget:u.a.oneOfType([g["a"],u.a.func]),constrain:b["a"].constrain},w.defaultProps={on:void 0,variant:"inverse",placement:"top",mountNode:null,positionTarget:void 0,constrain:"window"},x))||j)||j)||j)},B1vq:function(e,t,n){"use strict"
var o=n("ouhR")
var a=n.n(o)
n("s/PJ")
...
let o=n.offset(),i=n.outerWidth(),r=n.outerHeight(),s=o.top,l=s+r,c=o.left,d=c+i,u="html,body"==this.selector?a.a.windowScrollTop():this.scrollTop(),b=this.scrollLeft(),h=this.outerHeight(),p=this.outerWidth()
...
c<0?t.scrollLeft=c+b:d>p&&(t.scrollLeft=d+b-p+20)
...
return`${e}_${t}${n}`},urlFor(e,{combinedChecksum:t,includesNoVariables:n}){const o=n?"no_variables":i.getCssVariant()
...
a.a.isReady?i():a()(document).ready(()=>i())},RhCJ:function(e,t,n){"use strict"
...
var F=(B=Object(f["a"])("8.0.0",{label:"renderLabel",required:"isRequired",inline:"display"}),U=Object(x["j"])(O,q),B(C=U(C=(z=S=function(e){Object(s["a"])(n,e)
var t=Object(l["a"])(n)
function n(e){var o
Object(i["a"])(this,n)
o=t.call(this)
...
var j=n("jsCG")
var w=n("AdN2")
var x=function(e){var t=e.typography,n=e.spacing
return{fontFamily:t.fontFamily,fontWeight:t.fontWeightNormal,fontSize:t.fontSizeSmall,padding:n.small}}
var O,B,U,C,S,z
var q={componentId:"eZLSb",template:function(e){return"\n\n.eZLSb_bGBk{box-sizing:border-box;display:block;font-family:".concat(e.fontFamily||"inherit",";font-size:").concat(e.fontSize||"inherit",";font-weight:").concat(e.fontWeight||"inherit",";padding:").concat(e.padding||"inherit","}")},root:"eZLSb_bGBk"}
var F=(O=Object(h["a"])("8.0.0",{tip:"renderTip",variant:"color"}),B=Object(k["a"])(),U=Object(v["j"])(x,q),O(C=B(C=U(C=(z=S=function(e){Object(s["a"])(n,e)
var t=Object(l["a"])(n)
function n(){var e
Object(i["a"])(this,n)
...
return e}Object(r["a"])(n,[{key:"renderTrigger",value:function(){var e=this.props,t=e.children,o=e.as
var i=this.state.hasFocus
var r={"aria-describedby":this._id}
if(o){var s=Object(p["a"])(n,this.props)
var l=Object(_["a"])(this.props,n.propTypes)
return d.a.createElement(s,Object.assign({},l,r),t)}return"function"===typeof t?t({focused:i,getTriggerProps:function(e){return Object(a["a"])({},r,{},e)}}):Object(f["a"])(this.props.children,r)}},{key:"render",value:function(){var e=this
var t=this.props,n=t.renderTip,a=t.isShowingContent,i=t.defaultIsShowingContent,r=t.on,s=t.placement,l=t.mountNode,c=t.constrain,u=t.offsetX,b=t.offsetY,h=t.positionTarget,p=t.onShowContent,f=t.onHideContent,m=t.tip,y=(t.variant,Object(o["a"])(t,["renderTip","isShowingContent","defaultIsShowingContent","on","placement","mountNode","constrain","offsetX","offsetY","positionTarget","onShowContent","onHideContent","tip","variant"]))
var v=this.props.variant
v=v?"default"===v?"primary-inverse":"primary":this.props.color
return d.a.createElement(j["a"],Object.assign({},Object(_["b"])(y),{isShowingContent:a,defaultIsShowingContent:i,on:r,shouldRenderOffscreen:true,shouldReturnFocus:false,placement:s,color:"primary"===v?"primary-inverse":"primary",mountNode:l,constrain:c,shadow:"none",offsetX:u,offsetY:b,positionTarget:h,renderTrigger:function(){return e.renderTrigger()},onShowContent:p,onHideContent:f,onFocus:this.handleFocus,onBlur:this.handleBlur}),d.a.createElement("span",{id:this._id,className:q.root,role:"tooltip"},n?Object(g["a"])(n):m))}}])
n.displayName="Tooltip"
return n}(c["Component"]),S.propTypes={children:b.a.oneOfType([b.a.node,b.a.func]).isRequired,renderTip:b.a.oneOfType([b.a.node,b.a.func]),isShowingContent:b.a.bool,defaultIsShowingContent:b.a.bool,as:b.a.elementType,on:b.a.oneOfType([b.a.oneOf(["click","hover","focus"]),b.a.arrayOf(b.a.oneOf(["click","hover","focus"]))]),color:b.a.oneOf(["primary","primary-inverse"]),placement:m["a"].placement,mountNode:m["a"].mountNode,constrain:m["a"].constrain,offsetX:b.a.oneOfType([b.a.string,b.a.number]),offsetY:b.a.oneOfType([b.a.string,b.a.number]),positionTarget:b.a.oneOfType([w["a"],b.a.func]),onShowContent:b.a.func,onHideContent:b.a.func,tip:b.a.node,variant:b.a.oneOf(["default","inverse"])},S.defaultProps={renderTip:void 0,isShowingContent:void 0,defaultIsShowingContent:false,on:void 0,color:"primary",placement:"top",mountNode:null,constrain:"window",offsetX:0,offsetY:0,positionTarget:void 0,onShowContent:function(e){},onHideContent:function(e,t){t.documentClick}},z))||C)||C)||C)},cClk:function(e,t,n){"use strict"
n.d(t,"a",(function(){return o}))
...
var b=n("98st")
function h(){return document.getElementById("flash_screenreader_holder")}function p(e){let t=e.label,n=e.closeButtonLabel,i=e.onDismiss,c=e.children,d=Object(a["a"])(e,["label","closeButtonLabel","onDismiss","children"])
return r.a.createElement(b["a"],Object.assign({liveRegion:h},d,{label:t,onDismiss:i}),Object(o["a"])(b["a"].Header,{},void 0,Object(o["a"])(s["a"],{"data-testid":"instui-modal-close",placement:"end",offset:"medium",onClick:i},void 0,n||u.t("Close")),Object(o["a"])(l["a"],{},void 0,t)),c)}["Header","Body","Footer"].forEach(e=>p[e]=b["a"][e])
p.defaultProps={closeButtonLabel:void 0}},eAd9:function(e,t,n){(function(t){var n=false
var o
var a
...
e.removeChild(t)
return o}function r(){return document.documentElement.scrollHeight>window.innerHeight}function s(e){if("undefined"===typeof document||n)return
var t=document.documentElement
a=window.pageYOffset
r()?t.style.width="calc(100% - "+i()+"px)":t.style.width="100%"
...
"undefined"!==typeof e.exports?e.exports=d:t.noScroll=d})(this)},eGSd:function(e,t,n){"use strict"
n.d(t,"a",(function(){return o}))
...
return i}}function _(e){s=e
l.push(setTimeout(m,t))
return d?p(e):i}function f(e){var n=e-r
var o=e-s
var a=t-n
return u?Math.min(a,h-o):a}function g(e){var n=e-r
var o=e-s
return"undefined"===typeof r||n>=t||n<0||u&&o>=h}function m(){var e=Date.now()
if(g(e))return y(e)
l.push(setTimeout(m,f(e)))}function y(e){j()
if(b&&o)return p(e)
o=a=void 0
...
a=this
r=e
if(n){if(0===l.length)return _(r)
if(u){l.push(setTimeout(m,t))
return p(r)}}0===l.length&&l.push(setTimeout(m,t))
return i}w.cancel=v
w.flush=k
...
var O=Object(g["d"])({map:x,version:"8.0.0"})
var B,U,C,S,z,q
...
var A=(B=Object(y["a"])("8.0.0",{ellipsis:"<TruncateText />"}),U=Object(j["a"])(),C=Object(g["j"])(w,F,O),B(S=U(S=C(S=(q=z=function(e){Object(c["a"])(t,e)
...
var n=this.props,i=n.border,r=n.children,s=n.color,l=n.level,c=n.margin,d=n.elementRef,b=n.ellipsis,h=Object(a["a"])(n,["border","children","color","level","margin","elementRef","ellipsis"])
var p=Object(v["a"])(t,this.props,(function(){return"reset"===l?"span":l}))
return u.a.createElement(f["a"],Object.assign({},Object(k["b"])(h),{className:_()((e={},Object(o["a"])(e,F.root,true),Object(o["a"])(e,F["level--".concat(l)],true),Object(o["a"])(e,F["color--".concat(s)],s),Object(o["a"])(e,F["border--".concat(i)],"none"!==i),Object(o["a"])(e,F.ellipsis,b),e)),as:p,margin:c,elementRef:d}),r)}}])
t.displayName="Heading"
return t}(d["Component"]),z.propTypes={border:h.a.oneOf(["none","top","bottom"]),children:m["a"],color:h.a.oneOf(["primary","secondary","primary-inverse","secondary-inverse","inherit"]),level:h.a.oneOf(["h1","h2","h3","h4","h5","reset"]),as:h.a.elementType,margin:g["c"].spacing,elementRef:h.a.func,ellipsis:h.a.bool},z.defaultProps={children:null,margin:void 0,elementRef:void 0,border:"none",color:"inherit",level:"h2"},q))||S)||S)||S)},mykf:function(e,t,n){"use strict"
...
if(!(null===(t=ENV)||void 0===t||null===(n=t.FEATURES)||void 0===n?void 0:n.new_math_equation_handling)){const t=a()("<div/>").html(e.attr("x-canvaslms-safe-mathml")).html()
...
o=[]
t={}
e.exports=n=function(e,n,a){var i,r,s,l,c,d,u,b,h
null==a&&(a=true)
...
i=(null!=n?n.decimal:void 0)||t.decimal}u=""+h+i+a
d=o[u]
if(null==d){s=a?3:1
d=o[u]=new RegExp("^\\s*([+-]?(?:(?:\\d{1,3}(?:\\"+h+"\\d{"+s+",3})+)|\\d*))(?:\\"+i+"(\\d*))?\\s*$")}b=e.match(d)
...
//# sourceMappingURL=edit_rubric-c-71ad4cc8e2.js.map